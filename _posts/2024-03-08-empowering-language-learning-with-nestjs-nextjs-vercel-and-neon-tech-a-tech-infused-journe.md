...
[Flash-cards app with OpenAI](https://medium.com/@henrique.weiand/flash-cards-apps-with-chatgpt-1bf698a2dc30)
...
And there’s one more that I haven’t written about yet, but it is online as a platform and also available to contribute or download for free. The website is [quiz-english.com](https://quiz-english.com/)

[Quiz-English: Learn English by doing quizzes](https://quiz-english.com/)
...
In my projects, I've employed a variety of technologies such as NestJS, NextJS, React-Native, Postgres, Mongo, and more. Each technology has its pros and cons, but in my experience, I've found that if you're looking to quickly bring your idea to life, Vercel and NextJS are excellent choices. With Vercel, you can host both the backend and frontend closer together, and easily integrate with services like Postgres or Mongo—all without any cost! [Quiz-English.com](https://quiz-english.com/) is a prime example of this approach. Here's a rundown of the technologies powering the project:

- [Vercel](https://vercel.com/) (Host)
- [Github](https://github.com/) (Repository)
- [NextJS](https://nextjs.org/) (Frontend and backend)
- [Neon.tech](http://Neon.tech) (Postgres database)
- [Cleark](https://clerk.com/) (Auth provider)

### Plans

In the future, I aim to continue sharing my insights and experiences through technical blog posts on platforms like [Medium](https://medium.com/@henrique.weiand) and [dev.to](https://dev.to/henriqueweiand). My goal is to provide more real-world examples, use cases, and interesting topics that can benefit others in the tech community. Additionally, I've initiated a community centered around NestJS called NestJS Ninja, which you can find on Medium. Through this community, I hope to foster the growth of the JavaScript ecosystem and promote NestJS as a versatile framework.

[NestJS Ninja – Medium](https://medium.com/nestjs-ninja)

### Conclusion

In conclusion, my journey in exploring language learning through technology has led me to develop projects like [Quiz-English.com](https://quiz-english.com/) and embrace a variety of technologies like NextJS and Vercel. As I continue to share my experiences and insights through platforms like [Medium](https://medium.com/@henrique.weiand) and [dev.to](https://dev.to/henriqueweiand), I'm excited to contribute to the tech community and promote the growth of frameworks like NestJS through initiatives such as NestJS Ninja. I invite you to join me on this journey of learning, collaboration, and innovation. Together, let's explore the endless possibilities that technology offers for education and beyond.
